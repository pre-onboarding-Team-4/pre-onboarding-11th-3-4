...
[2-1. Context API를 활용한 API 연동 Best Practice 선정](#-context-api를-활용한-api-연동-best-practice-선정)

[2-2. 이슈 목록 및 상세 화면 기능 구현 Best Practice 선정](#-이슈-목록-및-상세-화면-기능-구현-best-practice-선정)

[2-3. 에러 화면 구현 Best Practice 선정](#-에러-화면-구현-best-practice-선정)
...
[3-1. 이전 데이터의 잔류로 인한 화면 깜빡임 발생](#-이전-데이터의-잔류로-인한-화면-깜빡임-발생)

[3-2. 무한스크롤시 총 페이지당 아이템의개수가 10개미만일때 중복 데이터 요청 발생](#-무한스크롤시-총-페이지당-아이템의개수가-10개미만일때-중복-데이터-요청-발생)

[3-3. 무한스크롤시 마지막 페이지 도달시 예외처리 적용](#-무한스크롤시-마지막-페이지-도달시-예외처리-적용)
